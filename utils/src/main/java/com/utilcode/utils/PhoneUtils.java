...
public class PhoneUtils {
    ...
    public static String getIMEI() {
        TelephonyManager tm = (TelephonyManager) Utils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
        if (!PermissionUtils.checkPermission(Utils.getContext(),Manifest.permission.READ_PHONE_STATE)) {
            PermissionUtils.requestPermission(Utils.getContext(),Manifest.permission.READ_PHONE_STATE,1);
        }
